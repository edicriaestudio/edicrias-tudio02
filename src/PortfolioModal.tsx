...
const templatesData: TemplateItem[] = [
  {
    id: 'hero-rio-estate',
    num: '00',
    title: 'Rio Estate / Imobili�ria Drone',
    category: 'hero',
    categoryLabel: 'PROJETO VIP',
    tag: 'Real Estate & Luxo',
    desc: 'Template cinematogr�fico de alt�ssimo padr�o para im�veis de luxo. Apresenta design full-screen e est�tica de imagens a�reas imersivas.',
    rating: '5.0 ?????',
    likes: 4100,
  ...
  },
  {
    ...
    desc: 'Interface de plataforma web imersiva. Ambienta��o em floresta m�stica bioluminescente, tipografia ousada e bot�es em glassmorphism neon.',
    rating: '5.0 ?????',
    likes: 3010,
  ...
  },
  {
    ...
    desc: 'Interface futurista de alto impacto com est�tica cyberpunk, tons de neon p�rpura, tipografia t�cnica e anima��es GSAP 60fps.',
    rating: '5.0 ?????',
    likes: 3120,
  ...
  },
  {
    ...
    num: '00',
    title: 'SUV Cinematic / Natureza Et�rea',
    category: 'hero',
    categoryLabel: 'PROJETO VIP',
    tag: 'Cinematic & 3D WebGL',
    desc: 'Projeto autoral imersivo de alt�ssima convers�o. Apresenta transi��es suaves, tipografia de luxo e uma atmosfera et�rea de natureza misturada com o digital.',
    rating: '5.0 ?????',
    likes: 2540,
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="font-mono text-xs uppercase tracking-[0.2em] text-cyan-300 font-medium">
                EDICRIA STUDIO • {templatesData.length} PROJETOS & TEMPLATES PROFISSIONAIS
              </span>
            </div>
